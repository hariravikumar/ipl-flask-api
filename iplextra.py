...
import numpy as np
import json
from flask import Response,jsonify,wrappers
...
ipl_matches ="/Users/harikrishnaravikumar/PycharmProjects/ipl-api-project/resources/IPL_Matches_2008_2022 - IPL_Matches_2008_2022.csv"
matches = pd.read_csv(ipl_matches)


ipl_ball="/Users/harikrishnaravikumar/PycharmProjects/ipl-api-project/resources/IPL_Ball_by_Ball_2008_2022 - IPL_Ball_by_Ball_2008_2022.csv"
...
def batsmanRecord(batsman, df):
    ...
    #print("DF")
    #print(df[['ID','innings','batter','batsman_run','BowlingTeam']])
...
def bowlerAPIs(bowler, balls=bowler_data):
    df = balls[balls.innings.isin([1, 2])]  # Excluding Super overs
    self_record = bowlerRecord(bowler, df=df)
    TEAMS = matches.Team1.unique()
    against = {team: bowlerVsTeam(bowler, team, df) for team in TEAMS}
